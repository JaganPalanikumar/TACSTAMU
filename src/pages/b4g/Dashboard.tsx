...
export default function Dashboard() {
  ...
  const [teamDashboard, setTeamDashboard] = useState(false);
          ...
          <>
            ...
            <div className="bg-[--container-background] rounded-[3rem] p-12 shadow-xl flex flex-col gap-6 text-center">
              ...
              <button
                ...
                className={`mx-auto px-8 py-3 rounded-full transition hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed ${profile?.participating ? "border border-red-400 text-red-500 hover:bg-red-50" : "bg-green-500 text-white hover:bg-green-600"}`}
              >
                {updating
                  ? profile?.participating
                    ? "Cancelling..."
